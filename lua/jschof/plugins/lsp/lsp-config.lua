return {
	...
	config = function()
		...
		local on_attach = function(client, bufnr)
			...
			map("n", "<leader>[", function() vim.diagnostic.jump({ count = -1, float = true }) end, "Go to previous diagnostic", bufnr)
			map("n", "<leader>]", function() vim.diagnostic.jump({ count = 1, float = true }) end, "Go to next diagnostic", bufnr)
